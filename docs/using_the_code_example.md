...
The following example clones the "[LittleFS](https://github.com/Infineon/mtb-example-psoc-edge-filesystem-littlefs-freertos)" application with the desired name "LittleFS" configured for the *KIT_PSE84_EVAL_EPC2* BSP into the specified working directory, *C:/mtb_projects*:

   ```
   project-creator-cli --board-id KIT_PSE84_EVAL_EPC2 --app-id mtb-example-psoc-edge-filesystem-littlefs-freertos --user-app-name LittleFS --target-dir "C:/mtb_projects"
   ```
